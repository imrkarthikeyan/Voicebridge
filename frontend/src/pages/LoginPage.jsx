        ...
        <div className="w-full max-w-md">
          <div className="p-8 rounded-2xl bg-slate-900/90 border border-slate-800 shadow-2xl">
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl font-bold font-heading text-white">Organizer Portal</h1>
              <p className="text-slate-400 text-xs mt-1">Sign in to manage audience microphone sessions</p>
            </div>
